...
class AddonCancelMethodView(MethodView):
    ...
    def __init__(self, config: dict = read_config()) -> None:
        ...
        self.token = get_token(config["appdirect"]["addon_client_id"], config["appdirect"]["addon_client_secret"])
    ...
    def get(self):
        ...
        if response.status_code == 200:
            ...
            subscription = self.service.cancel_addon(self.appdirect_uuid, response.json())
            success = AppDirectSuccess(subscription)
